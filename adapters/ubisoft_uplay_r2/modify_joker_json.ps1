# adapters\ubisoft_uplay_r2\modify_joker_json.ps1
...
#      Jokerverse eventually creates for this Steam appid (matched on the
...
if ($missing.Count -gt 0) {
    Write-Host "[ERROR] ubisoft_uplay_r2\modify_joker_json.ps1: missing env var(s): $($missing -join ', ')"
    exit 1
}
